(ns js-budget-analyzer.goals
  (:require
   [js-budget-analyzer.data.labels  :refer [developer sdr manager]]
   [js-budget-analyzer.staff-by-role :refer [staff-by-role]]
   [js-budget-analyzer.all-config-stats :refer [all-config-stats]]
   [js-budget-analyzer.deals :refer [deals]]
   [js-budget-analyzer.profit :refer [profit] :reload true]
   [js-budget-analyzer.cost-per-employee :refer [cost-per-employee] :reload true]
   ))
(defn g
